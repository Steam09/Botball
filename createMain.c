...
// variables
int lm_speed = 195; //changed from 192
int rm_speed = 194; //changed from 195
...
int main()
{
    ...
    */
    ...
    drive_forward(700); // push //CHANGED from 1200
    turn_right(120); // turn right to unlatch from rock
    drive_backward(700); // back up to prepare for poms
    turn_left(310);
    drive_backward(1600);
    
    // 2 orange poms (TESTED)
    turn_left(415); //CHANGED from 420
    
    // taller green multipliers
    msleep(500);
    drive_forward(2550); //was 2585 
    msleep(1000);
...
*/
    ...
    drive_forward(350);
    drive_backward(500);
    turn_left(1000); //800 to go straight
    msleep(500);
